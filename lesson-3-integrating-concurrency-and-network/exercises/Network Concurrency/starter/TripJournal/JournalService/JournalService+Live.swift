...
class JournalServiceLive: JournalService {
    ...
    // 1. Create a URLSession property for managing network requests
    ...
    init() {
        // 2.  Initialize URLSessionConfiguration with custom settings
        // 3. Initialize the URLSession property with the configured URLSessionConfiguration
    ...
    private func performNetworkRequest<T: Decodable>(_ request: URLRequest, responseType: T.Type) async throws -> T {
        // 4. Use urlSession to perform the data task and get data and response
    ...
    private func performVoidNetworkRequest(_ request: URLRequest) async throws {
        // 5. Use urlSession to perform the data task and get the response
